			...
			<table class="table table-borderless">
				<tbody>
					<tr>
						...
						<td class="text-center"><h3>Sam Photography</h3></td>
						<td rowspan="3" width="16%">&nbsp;</td>
					</tr>
					<tr>
						<td class="text-center">Phone : +62 823-2275-3411 | E-mail : samphotography@gmail.com</td>
					</tr>
					<tr>
						<td class="text-center">Dalegan Panceng Gresik</td>
					</tr>
				</tbody>
			</table>
			<hr class="line-top" />
